...
UA_Double           *pubCounterData;
UA_DataValue        *staticValueSource;
UA_Double           *pubCounterData1;//线程4
UA_DataValue        *staticValueSource1;//线程4
UA_UInt64           *pubCounterData2;//线程4
UA_DataValue        *staticValueSource2;//线程4
UA_Boolean           *pubCounterData3;//线程4
UA_DataValue        *staticValueSource3;//线程4
UA_Boolean           *pubCounterData4;//线程4
UA_DataValue        *staticValueSource4;//线程4
UA_Boolean           *pubCounterData5;//线程4
UA_DataValue        *staticValueSource5;//线程4.
UA_Boolean           *pubCounterData6;//线程4
...
UA_NodeId numberNode = {1, UA_NODEIDTYPE_NUMERIC, {3900}};
UA_NodeId rtpostionNode = {1, UA_NODEIDTYPE_NUMERIC, {3901}};
UA_NodeId settingTSNNode = {1, UA_NODEIDTYPE_NUMERIC, {3902}};
UA_NodeId CycletimeTSNNode = {1, UA_NODEIDTYPE_NUMERIC, {3908}};
UA_NodeId QbvTSNNode = {1, UA_NODEIDTYPE_NUMERIC, {3909}};
UA_NodeId statusNode = {1, UA_NODEIDTYPE_NUMERIC, {3903}};
UA_NodeId stopcurrentlyNode = {1, UA_NODEIDTYPE_NUMERIC, {3904}};
UA_NodeId resetNode = {1, UA_NODEIDTYPE_NUMERIC, {3905}};
UA_NodeId backtozeroNode = {1, UA_NODEIDTYPE_NUMERIC, {3906}};
UA_NodeId moveNode = {1, UA_NODEIDTYPE_NUMERIC, {3907}};
#if defined(PUBLISHER)
...
addDataSetField(UA_Server *server) {
    ...
    staticValueSource = UA_DataValue_new();
     staticValueSource1 = UA_DataValue_new();//线程4
     staticValueSource2 = UA_DataValue_new();
     staticValueSource3 = UA_DataValue_new();
     staticValueSource4 = UA_DataValue_new();
    ...
    UA_DataSetFieldConfig counterValue1;//线程4
    UA_DataSetFieldConfig counterValue2;//线程4
    UA_DataSetFieldConfig counterValue3;//线程4
    UA_DataSetFieldConfig counterValue4;//线程4
    ...
    memset(&counterValue3, 0, sizeof(UA_DataSetFieldConfig));//线程4
    memset(&counterValue4, 0, sizeof(UA_DataSetFieldConfig));//线程4
    ...
    UA_UInt64 *countValue1 = UA_UInt64_new();//为什么一定要这两句才不会内存泄露//线程4
    pubCounterData1 = countValue1;//线程4
   UA_UInt64 *countValue2 = UA_UInt64_new();//为什么一定要这两句才不会内存泄露//线程4
    pubCounterData2 = countValue2;//线程4
     UA_UInt64 *countValue3 = UA_UInt64_new();//为什么一定要这两句才不会内存泄露//线程4
    pubCounterData3 = countValue3;//线程4
    UA_UInt64 *countValue4 = UA_UInt64_new();//为什么一定要这两句才不会内存泄露//线程4
    pubCounterData4 = countValue4;//线程4
    UA_UInt64 *countValue5 = UA_UInt64_new();//为什么一定要这两句才不会内存泄露//线程4
    pubCounterData5 = countValue5;//线程4
    UA_UInt64 *countValue6 = UA_UInt64_new();//为什么一定要这两句才不会内存泄露//线程4
    ...
    UA_Variant_setScalar(&staticValueSource3->value, pubCounterData3, &UA_TYPES[UA_TYPES_BOOLEAN]);//线程4
    UA_Variant_setScalar(&staticValueSource4->value, pubCounterData4, &UA_TYPES[UA_TYPES_BOOLEAN]);//线程4
    ...
    counterValue1.field.variable.rtValueSource.staticValueSource = &staticValueSource1;//线程4
     counterValue2.field.variable.rtValueSource.rtFieldSourceEnabled = UA_TRUE;//线程4
    counterValue2.field.variable.rtValueSource.staticValueSource = &staticValueSource2;//线程4
    counterValue3.field.variable.rtValueSource.rtFieldSourceEnabled = UA_TRUE;//线程4
    counterValue3.field.variable.rtValueSource.staticValueSource = &staticValueSource3;//线程4
     counterValue4.field.variable.rtValueSource.rtFieldSourceEnabled = UA_TRUE;//线程4
    counterValue4.field.variable.rtValueSource.staticValueSource = &staticValueSource4;//线程4
     counterValue5.field.variable.rtValueSource.rtFieldSourceEnabled = UA_TRUE;//线程4
    counterValue5.field.variable.rtValueSource.staticValueSource = &staticValueSource5;//线程4
     counterValue6.field.variable.rtValueSource.rtFieldSourceEnabled = UA_TRUE;//线程4
    ...
    UA_Server_addDataSetField(server, publishedDataSetIdent, &counterValue, &dataSetFieldIdent);
     UA_Server_addDataSetField(server, publishedDataSetIdent, &counterValue1, &dataSetFieldIdent);
     UA_Server_addDataSetField(server, publishedDataSetIdent, &counterValue2, &dataSetFieldIdent);
      UA_Server_addDataSetField(server, publishedDataSetIdent, &counterValue3, &dataSetFieldIdent);
    UA_Server_addDataSetField(server, publishedDataSetIdent, &counterValue4, &dataSetFieldIdent);
     ...
     UA_Server_readValue(server, rtpostionNode, &pubrtpositon);
      ...
      //  *pubCounterData      = *pubCounterData + 1.00;
       ...
       if (subCounterData > 0)
            ...
            //printf("接受 %d\n,   %d.%d\n",subCounterData,dataReceiveTime.tv_sec,dataReceiveTime.tv_nsec);
...
void *thread1997(void *arg) {
    ...
    *pubCounterData1=0.00;
    UA_Variant pubcyclytime;
      ...
      UA_Variant_init(&pubQbvOffset);
      UA_Variant pubenableflag;
      UA_Variant_init(&pubenableflag);
      UA_Variant pubstopcurrentlyflag;
      UA_Variant_init(&pubstopcurrentlyflag);
      UA_Variant pubresetflag;
      UA_Variant_init(&pubresetflag);
      UA_Variant pubbacktozeroflag;
   ...
   *pubCounterData2=0;
    ...
    *pubCounterData7=0;
    ...
    UA_Server_readValue(server, QbvTSNNode, &pubQbvOffset);
       *pubCounterData2      =*(UA_UInt64*)pubQbvOffset.data;
       UA_Server_readValue(server, statusNode, &pubenableflag);
       *pubCounterData3      =*(UA_Boolean*)pubenableflag.data;
      UA_Server_readValue(server, stopcurrentlyNode, &pubstopcurrentlyflag);
       *pubCounterData4      =*(UA_Boolean*)pubstopcurrentlyflag.data;
       UA_Server_readValue(server, resetNode, &pubresetflag);
       *pubCounterData5      =*(UA_Boolean*)pubresetflag.data;
       UA_Server_readValue(server, backtozeroNode, &pubbacktozeroflag);
...
DefineeDevice(UA_Server *server) {
    ...
    UA_UInt64 TSNvalue2 = 3354968;
    UA_Variant_setScalar(&stAttr2.value, &TSNvalue2, &UA_TYPES[UA_TYPES_UINT64]);
...
*/
    ...
    /*线程4*/
    char threadNameUserApplication1[22] = "UserApplicationPubSub1";
   int temp;
        memset(&userThreadID1, 0, sizeof(userThreadID1));          //comment1
        /*创建线程*/
        if((temp = pthread_create(&userThreadID1, NULL, thread1997, serverConfig)) != 0)  //comment2     
                printf("线程4创建失败!\n");
        else
                printf("线程4被创建\n");
#endif
