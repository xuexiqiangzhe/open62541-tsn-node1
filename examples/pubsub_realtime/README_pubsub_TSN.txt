...
For ETF Transmit: (In both nodes)
    ...
    sudo tc qdisc add dev eth0 parent $MQPRIO_NUM:1 etf offload clockid CLOCK_TAI delta 150000
    sudo tc qdisc add dev eth0 parent $MQPRIO_NUM:2 etf offload clockid CLOCK_TAI delta 150000
